...
CHESSAPP.ui = (function(){
	...
	createInitial = function(){
		...
		diff_meter = document.createElement('input');
    	diff_meter.id = "volume";
    	diff_meter.type = 'range';
    	diff_meter.min = 0;
    	diff_meter.max = 1;
    	diff_meter.value = 0.5;
    	diff_meter.step = 0.1;

		initial.className = "initial overscreen";  

		title.appendChild(document.createTextNode("Choose bot difficulty"));
		btn.appendChild(document.createTextNode("Start"));
		
		frag.appendChild(title);
		frag.appendChild(diff_meter);
		...
		//TODO: difficulty meegeven naar CHESSAPP
		CHESSAPP.utils.bind(btn, "click", that.modeClicked);
